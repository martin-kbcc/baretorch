...
NUM_EPOCHS=1
BATCH_SIZE=8              # Per-GPU batch size (chosen vs. rejected pairs double VRAM)
GRAD_ACCUM=1              # Effective Batch Size = 8 * 1 * 8 GPUs = 64 preference pairs/step
LEARNING_RATE=5e-6        # Target SimPO learning rate for 500M models
...
SEQ_LEN=4096              # Matched to native 4K context window
...
echo "================================================================================"
echo "🚀 LAUNCHING SIMPO ALIGNMENT ON 8x NVIDIA H100 SXM (80GB)"
echo "================================================================================"
