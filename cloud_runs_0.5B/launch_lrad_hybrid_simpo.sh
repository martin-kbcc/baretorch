...
# ==============================================================================
NUM_EPOCHS=1
PER_GPU_BATCH_SIZE=8       # Per-GPU batch size (chosen vs. rejected pairs double VRAM)
GRAD_ACCUM=2              # Global batch size = 4 GPUs * 8 batch * 2 accum = 64 preference pairs/step
