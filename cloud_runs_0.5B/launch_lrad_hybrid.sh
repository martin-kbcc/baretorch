...
# ==============================================================================
#                   Optimization & Hyperparameters (25B Tokens)
# ==============================================================================
...
WARMUP_STEPS=1000
WEIGHT_DECAY=0.1
MAX_STEPS=47683  # 25,000,000,000 tokens / (4 GPUs * 32 batch * 2 accum * 2048 seq_len)
...
echo "  ├─ Target Runway    : ~25.0 Billion Tokens (${MAX_STEPS} steps)"
...
echo "  ├─ Step Throughput  : ${TOKENS_PER_STEP} tokens/step (~0.52M tokens/step)"
echo "  ├─ Architecture     : ${NUM_LAYERS} Layers (d_model=${D_MODEL}, heads=${NUM_HEADS}, rank=${RANK})"
echo "  ├─ Layer Sequence   : ${LAYER_SEQUENCE}"
echo "  ├─ Checkpoint Freq  : Every ${SAVE_STEPS} steps (~1.05B tokens)"
