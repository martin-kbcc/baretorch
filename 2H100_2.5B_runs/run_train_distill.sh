...
# Hardware Setup (2x H100 SXM5 Workstation)
NUM_GPUS=2
...
# Optimization (Scaled for 80GB H100 VRAM)
PER_GPU_BATCH_SIZE=8    # Scaled up for 80GB VRAM
GRAD_ACCUM=4            # Effective batch size = 64 seqs/step (~131k tokens/step)
LEARNING_RATE=3e-4
SCHEDULER="wsd"
WARMUP_STEPS=100
WEIGHT_DECAY=0.1
...
# Paths
OUTPUT_DIR="${ROOT_DIR}/checkpoints_distill_2.5B_h100"
...
echo "======================================================================"
echo "🚀 Launching BareTorch Distillation Engine (2x H100 SXM5 80GB)..."
