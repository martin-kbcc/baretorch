...
def main():
    ...
    if local_rank == 0:
        ...
        if enable_r2_sync:
            ...
            logger.info(f"📤 Syncing final Cold-Start SFT model weights to Cloudflare R2 ({target_r2_path})...")
            cmd = [
                "rclone", "copy",
                args.output_dir,
                target_r2_path,
            ...
            logger.info("✅ Final Cold-Start SFT weights successfully uploaded to Cloudflare R2!")
