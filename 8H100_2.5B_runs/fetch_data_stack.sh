...
echo "================================================================="
echo "📥 Fetching Deterministic stack_dedup Token Subset (~24B Tokens)"
echo "================================================================="
echo "Target Root Directory: ${LOCAL_TARGET_DIR}"
echo "Deterministic Seed:    ${RANDOM_SEED}"
echo "================================================================="

# Target stack_dedup exclusively (DatasetName:Ratio)
DATASETS=(
...
echo ""
echo "================================================================="
echo "🎉 stack_dedup Sync Complete!"
echo "Data location: ${LOCAL_TARGET_DIR}/stack_dedup"
echo "================================================================="